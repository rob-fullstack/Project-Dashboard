<div class="modal-body clearfix">
    ...
    <?php if($related_to === 'projects'){?>
        <div class="form-group">
            <label for="add-class" class=" col-md-3">Additional Class</label>
            <div class=" col-md-9">
                <?php
                echo form_input(array(
                    "id" => "add-class",
                    "name" => "add-class",
                    "value" => $model_info->add_class,
                    "class" => "form-control",
    ...
    <?php if($related_to === 'projects'){?>
        <div class="form-group">
            <label for="order" class=" col-md-3">Order</label>
            <div class=" col-md-9">
                <?php
                echo form_input(array(
                    "id" => "order",
                    "name" => "order",
                    "value" => $model_info->order_number,
                    "class" => "form-control",
                    "placeholder" => 'Order'
                ));
                ?>
