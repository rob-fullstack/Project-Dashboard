        ...
        <ul class="" id="sidebar-menu">
            ...
            if ($this->login_user->user_type == "staff") {
                ...
                if (get_setting("module_event") == "1") {
                    $sidebar_menu[] = array("name" => "calendar", "url" => "events", "class" => "fa-calendar");
                }
                ...
                if (($this->login_user->role_id !== "0") && ($this->login_user->is_admin || $access_timecard)) {
                ...
                if (get_setting("module_event") == "1" && !in_array("calendar", $hidden_menu)) {
                    $sidebar_menu[] = array("name" => "calendar", "url" => "events", "class" => "fa-calendar");
                }
            ...
            foreach ($sidebar_menu as $main_menu) {
                ...
                <li class="<?php echo $active_class . " " . $expend_class . " " . $submenu_open_class . " $devider_class"; ?> main">
                    <a href="<?php echo_uri($main_menu['url']); ?>">
                        ...
                        <span><?php echo lang($main_menu['name']) ? lang($main_menu['name']) : ucfirst($main_menu['name']) ?></span>
    <?php
    if ($badge) {
