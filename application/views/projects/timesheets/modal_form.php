<?php echo form_open(get_uri("projects/save_timelog"), array("id" => "timelog-form", "class" => "general-form", "role" => "form", "autocomplete" => "off")); ?>
<div class="modal-body clearfix">
    ...
    <div class="clearfix">
        ...
        <div class="form-group">
            ...
            <div class="col-md-9">
                <?php
                echo form_dropdown("task_id", $tasks_dropdown, $model_info->task_id, array(
                    "class" => "form-control",
                    "data-rule-required" => true,
                    "data-msg-required" => lang("field_required"),
                ));
...
<script type="text/javascript">
    $(document).ready(function () {
        $("select[name='task_id']").prepend("<option value='' selected disabled>Select task</option>");
        $("select[name='task_id']").val("");
