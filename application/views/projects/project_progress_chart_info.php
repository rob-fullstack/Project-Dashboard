<div class="panel">
    ...
    <div class="p10 b-t b-b">
        Remaining Duration (Hours): <span class="<?php echo $project_time["work_hours"] < 0 ? 'text-danger' : ''?>"><?php echo $project_time['work_hours'] ?></span>
    </div>
...
<script>
    $(function () {
        ...
        // var hasExceededBudgetedTime = <?php echo $project_time["work_days"] < 0 ? 'true' : 'false'?>;
        // if (hasExceededBudgetedTime) {
        //     $.post('/index.php/projects/send_overtime_mail')
        // }
    });
</script>
