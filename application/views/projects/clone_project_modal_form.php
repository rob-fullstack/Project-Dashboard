...
<div class="modal-body clearfix">
    ...
    <div class="form-group">
        <label for="project_id" class=" col-md-3">Project ID</label>
        <div class=" col-md-9">
            <?php
    ...
    <div class="form-group">
        <label for="copy_project_members"class=" col-md-12">
            <?php
            echo form_checkbox("copy_project_members", "1", false, "id='copy_project_members' class='pull-left mr15'");
            ?>    
    ...
    <div class="form-group">
        <label for="copy_tasks"class=" col-md-12">
            <?php
            echo form_checkbox("copy_tasks", "1", false, "id='copy_tasks' class='pull-left '");
            ?>    
