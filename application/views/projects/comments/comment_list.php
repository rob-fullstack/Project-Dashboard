...
foreach ($comments as $comment) {
    ...
    ?>
    <div id="prject-comment-container-<?php echo $type . "-" . $comment->id; ?>" data-comment-id="<?php echo $comment->id; ?>"  class="comment-container media b-b mb15 <?php echo "comment-" . $type; ?>">
        ...
        <div class="media-body">
                ...
                <?php if ($this->login_user->is_admin || $comment->created_by == $this->login_user->id) { ?>
                    <span class="pull-right dropdown comment-dropdown">
                        ...
                        <ul class="dropdown-menu" role="menu">
                            ...
                            <?php if($comment->created_by == $this->login_user->id){?>
                                <li role="presentation"><a href="#" id="comment-edit" data-id="<?php echo $comment->id; ?>"><i class='fa fa-pencil'></i> <?php echo lang('edit');?></a></li>
                            <?php } ?>
                        </ul>
                    </span>
                <?php } ?>
            ...
            <p class="comment-content"><?php echo convert_mentions($comment->description); ?></p>
