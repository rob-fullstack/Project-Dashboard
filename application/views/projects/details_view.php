        ...
        <div class="col-md-12">
            <div class="page-title clearfix">
                <h1>
                    ...
                    <?php } else if ($project_info->status == "invoiced") { ?>
                        <i class="fa fa-check-circle text-success" title="<?php echo "Invoiced"; ?>"></i> 
                    ...
                    <?php echo "{$project_info->unique_project_id} | {$project_info->title}"; ?>
                    ...
                    <?php if ($show_actions_dropdown) { ?>
                        <span class="dropdown inline-block">
                            ...
                            <ul class="dropdown-menu dropdown-left" role="menu">
                                <?php if ($project_info->status == "open") { ?>
                                    <li role="presentation"><?php echo ajax_anchor(get_uri("projects/change_status/$project_info->id/completed"), "<i class='fa fa-check-circle'></i> " . lang('mark_project_as_completed'), array("class" => "", "title" => lang('mark_project_as_completed'), "data-reload-on-success" => "1", "data-generate-pdf" => $project_info->id)); ?> </li>
                                    <li role="presentation"><?php echo ajax_anchor(get_uri("projects/change_status/$project_info->id/invoiced"), "<i class='fa fa-check-circle'></i> " . "Mark Project as Invoiced", array("class" => "", "title" => "Mark Project as Invoiced", "data-reload-on-success" => "0")); ?> </li>
                                ...
                                <?php if ($project_info->status != "open") { ?>
                                    ...
                                    <li role="presentation">
                                        <a href="<?php echo get_uri("report/generate_pdf/$project_info->id") ?>" target="_blank"><i class="fa fa-list-alt"></i> Generate Report</a>
                                    </li>
                                    <?php
                                }
            ...
            <ul id="project-tabs" data-toggle="ajax-tab" class="nav nav-tabs classic" role="tablist">
                <?php if ($this->login_user->user_type === "staff") { ?>
                    ...
                    <li class="hidden"><a role="presentation" href="<?php echo_uri("projects/tasks/" . $project_info->id); ?>" data-target="#project-tasks-section"><?php echo lang('tasks')." ".lang("list"); ?></a></li>
                    ...
                    <?php } ?>
                    <li><a role="presentation" href="<?php echo_uri("projects/tasks_kanban/" . $project_info->id); ?>" data-target="#project-tasks-kanban-section"><?php echo lang('tasks'); ?></a></li>
                    <?php if ($show_gantt_info) { ?>
                        <li class="hidden"><a role="presentation" href="<?php echo_uri("projects/gantt/" . $project_info->id); ?>" data-target="#project-gantt-section"> <?php echo lang('gantt'); ?></a></li>
                    <?php } ?>
                    ...
                    <li class="hidden"><a role="presentation" href="<?php echo_uri("projects/comments/" . $project_info->id); ?>" data-target="#project-comments-section"> <?php echo lang('comments'); ?></a></li>
                    ...
                    <?php if ($show_expense_info) { ?>
                        <li><a  role="presentation" href="<?php echo_uri("projects/expenses/" . $project_info->id); ?>" data-target="#project-expenses"> Project Costs</a></li>
                    <?php } ?>   

                    <li><a role="presentation" href="<?php echo_uri("projects/project_review/" . $project_info->id); ?>" data-target="#project-customer-feedback-section"> Review</a></li>
                ...
                <?php } else { ?>
                    ...
                    <?php if ($show_tasks) { ?>
                        <li class="hidden"><a role="presentation" href="<?php echo_uri("projects/tasks/" . $project_info->id); ?>" data-target="#project-tasks-section"><?php echo lang('task')." ".lang("list"); ?></a></li>
                        <li><a role="presentation" href="<?php echo_uri("projects/tasks_kanban/" . $project_info->id); ?>" data-target="#project-tasks-kanban-section"><?php echo lang('task'); ?></a></li>
                    <?php } ?>
