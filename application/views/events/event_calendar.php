    ...
    <div class="row">
        <div class="col-md-12">
            <div class="page-title clearfix">
                ...
                <ul id="calendar-tabs" data-toggle="ajax-tab" class="nav nav-tabs classic" role="tablist">
                    <li><a role="presentation" href="<?php echo get_uri('events')?>" data-target="#task-calendar">Task Calendar</a></li>
                    <li><a role="presentation" href="<?php echo get_uri('events')?>" data-target="#task-calendar">Milestones</a></li>
                </ul>
            </div>
        </div>
    </div>
